    ...
    <Form {...form}>
      ...
      >
                  ...
                  <div className="w-full sm:w-5/12 flex items-center justify-center p-3 bg-white dark:bg-gray-800 border-b sm:border-b-0 sm:border-r border-dashed border-gray-300 dark:border-gray-600">
                    {preview ? (
                      <img
                        src={preview}
                        alt="Preview"
                        className="max-h-32 w-auto object-contain rounded-md border border-gray-200 dark:border-gray-700"
                      />
                    ) : (
        ...
        <AlertDialogFooter className="pt-4">
          <AlertDialogCancel className="bg-gray-100 dark:bg-gray-800 dark:text-gray-200 border dark:border-gray-700">
            Cancel
          </AlertDialogCancel>
          <Button
            type="submit"
